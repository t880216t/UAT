...
import { Card, Table, Select, Form, Input, Modal } from 'antd';
      ...
      <Card bordered={false}>
        <div className={styles.headerContainer}>
          <Select
            placeholder="请选择库"
            style={{ width: 220 }}
            onChange={value => this.handleLibChange(value)}
          >
            {allLibs &&
              allLibs.map(item => (
            ...
            {getFieldDecorator('doc', {
              ...
              <Editor
                ...
                init={{
                  ...
                  content_style:
                    'p {font-family: "Chinese Quote", -apple-system, BlinkMacSystemFont, "Segoe UI", "PingFang SC", "Hiragino Sans GB", "Microsoft YaHei", "Helvetica Neue", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";font-size: 14px;color: rgba(0, 0, 0, 0.65);}',
