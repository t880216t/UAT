...
export default class CasePage extends PureComponent {
  ...
  handleAddSubFolder = rightClickItem =>
    new Promise((resolve, reject) => {
      const clickId = rightClickItem.dataRef.id;
      const { treeList } = this.state;
      const listData = this.treeToList(treeList);
  ...
  handleAddCustomKeyword = rightClickItem =>
    new Promise((resolve, reject) => {
      const clickId = rightClickItem.dataRef.id;
      const { treeList } = this.state;
      const listData = this.treeToList(treeList);
  ...
  handleDeleteSubFolder = rightClickItem =>
    new Promise((resolve, reject) => {
  ...
  hanldeDeleteCase = rightClickItem =>
    new Promise((resolve, reject) => {
      const deleteId = rightClickItem.dataRef.id;
      const { dispatch } = this.props;
      dispatch({
      ...
      <div className={styles.container}>
        ...
        >
          ...
          {project && (
            <Select
              placeholder="请选择版本"
              value={selectVersion || undefined}
              className={styles.version_select_container}
              size="small"
