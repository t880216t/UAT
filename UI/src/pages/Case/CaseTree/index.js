...
export default class CaseTree extends PureComponent {
  ...
  handleRightMenuClick = e => {
    ...
    switch (code) {
      case '1':
        this.props.handleAddCase(rightClickItem).then(() => this.clearMenu());
        break;
      case '2':
        this.props.handleAddSubFolder(rightClickItem).then(() => this.clearMenu());
        break;
      case '3':
        this.props.handleAddCustomKeyword(rightClickItem).then(() => this.clearMenu());
        break;
      case '4':
        this.props.handleDeleteSubFolder(rightClickItem).then(() => {
          this.clearMenu();
          this.props.clearSelect();
        });
        break;
      case '5':
        this.props.handleCopyCase(rightClickItem).then(() => this.clearMenu());
        break;
      case '6':
        this.props.hanldeDeleteCase(rightClickItem).then(() => {
          this.clearMenu();
          this.props.clearSelect();
        });
        break;
              ...
              <TreeNode
                ...
                title={
                  <Input
                    ...
                    style={{ width: 100 }}
                    autoFocus
                    onBlur={e => submitAddFolder(e.target.value)}
                    onPressEnter={e => submitAddFolder(e.target.value)}
                  />
                }
                key="0-0-1"
              />
              ...
              <TreeNode
                ...
                title={
                  <Input
                    ...
                    style={{ width: 100 }}
                    autoFocus
                    onBlur={e => submitAddCase(e.target.value)}
                    onPressEnter={e => submitAddCase(e.target.value)}
                  />
                }
                key="0-0-1"
              />
              ...
              <TreeNode
                ...
                title={
                  <Input
                    ...
                    style={{ width: 100 }}
                    autoFocus
                    onBlur={e => submitAddCustomKeyword(e.target.value)}
                    onPressEnter={e => submitAddCustomKeyword(e.target.value)}
                  />
                }
                key="0-0-1"
              />
