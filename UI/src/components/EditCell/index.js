    ...
    return (
      <div id={cellId}>
        {editing ? (
          ...
          <div onMouseOver={() => this.handleMouseOver(record.id, dataIndex)}>
            <Popover
              placement="bottomLeft"
              title={this.beautySub(record[dataIndex], 30)}
              content={fetchingDesc ? <Spin size="small" /> : this.getStepDesc(stepDoc)}
              trigger="hover"
            >
              <div
