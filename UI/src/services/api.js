...
export async function queryCaseData(params) {
  return request(
    `/api/UAT/case/caseData?caseId=${params.caseId.toString()}&versionId=${
      params.versionId ? params.versionId.toString() : ''
...
export async function queryProjectGlobalValues(params) {
  return request(
    `/api/UAT/project/projectGlobalValues?id=${params.id.toString()}&_=${new Date()
      .getTime()
      .toString()}`,
  );
}
...
export async function queryGetLibKeywords(params) {
  return request(
    `/api/UAT/project/getLibKeywords?id=${params.id.toString()}&_=${new Date()
      .getTime()
      .toString()}`,
  );
}
...
export async function queryGetKeywordInfo(params) {
  return request(
    `/api/UAT/case/getKeywordInfo?caseId=${params.caseId.toString()}&_=${new Date()
      .getTime()
      .toString()}`,
  );
}
...
export async function queryTreeList(params) {
  return request(
    `/api/UAT/case/treeList?id=${params.id.toString()}&_=${new Date().getTime().toString()}`,
  );
}

export async function queryTaskReport(params) {
  return request(
    `/api/UAT/task/taskReport?id=${params.id.toString()}&_=${new Date().getTime().toString()}`,
  );
}

export async function queryTaskInfo(params) {
  return request(
    `/api/UAT/task/taskInfo?id=${params.id.toString()}&_=${new Date().getTime().toString()}`,
  );
}

export async function queryCaseTreeList(params) {
  return request(
    `/api/UAT/case/caseTreeList?id=${params.id.toString()}&_=${new Date().getTime().toString()}`,
  );
}

export async function queryCaseProjectConfig(params) {
  return request(
    `/api/UAT/case/caseProjectConfig?id=${params.id.toString()}&_=${new Date()
      .getTime()
      .toString()}`,
  );
}
...
export async function queryProjectList(params) {
  return request(
    `/api/UAT/project/projectList?status=${params.status.toString()}&_=${new Date()
      .getTime()
      .toString()}`,
  );
}
export async function queryProjectVersionList(params) {
  return request(
    `/api/UAT/project/projectVersionList?status=${params.status.toString()}&projectId=${params.projectId.toString()}&_=${new Date()
      .getTime()
      .toString()}`,
  );
}
...
export async function queryGetLibs(params) {
  return request(
    `/api/UAT/case/getLibs?status=${params.status.toString()}&_=${new Date().getTime().toString()}`,
  );
}

export async function queryGetAllLibs(params) {
  return request(
    `/api/UAT/project/getAllLibs?status=${params.status.toString()}&_=${new Date()
      .getTime()
      .toString()}`,
  );
}
